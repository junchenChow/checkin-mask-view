...
public class ObservableScrollView extends ScrollView implements Scrollable {
    ...
    public interface ISmartScrollChangedListener {
        void onScrolledUpAndDown(boolean down);
    }
    ...
    private void notifyScrollChangedListeners() {
        if (isScrolledToBottom) {
            if (mSmartScrollChangedListener != null) {
                mSmartScrollChangedListener.onScrolledUpAndDown(true);
            }
        }else {
            if (mSmartScrollChangedListener != null) {
                mSmartScrollChangedListener.onScrolledUpAndDown(false);
            }
        }
    }
    ...
    protected void onOverScrolled(int scrollX, int scrollY, boolean clampedX, boolean clampedY) {
        ...
        isScrolledToBottom = scrollY != 0 && clampedY;
    ...
    protected void onScrollChanged(int l, int t, int oldl, int oldt) {
        ...
        isScrolledToBottom = getScrollY() != 0 && getScrollY() + getHeight() - getPaddingTop() - getPaddingBottom() == getChildAt(0).getHeight();
        notifyScrollChangedListeners();
    }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        Log.i("onTouchEEE", ev.getActionMasked() + "__");
        if (hasNoCallbacks()) {
